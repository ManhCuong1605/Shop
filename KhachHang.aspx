...
<asp:Content ID="Content2" ContentPlaceHolderID="MyContent" runat="server">
    <div class="container-fluid">
        ...
        <label for="" class="form-label text-success">Địa Chỉ Khách Hàng</label>
            ...
            <div class="col-md-8">
                <asp:GridView ID="KhachHangList" runat="server" Width="849px" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="false" AutoGenerateSelectButton="True" OnSelectedIndexChanged="ChatlieuList_SelectedIndexChanged1">
                  <Columns>
